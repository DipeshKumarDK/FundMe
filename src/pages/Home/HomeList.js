...
function NatureList({ name, isLoading, campaigns }) {
  ...
  return (
    <div ref={ref} className="pt-10 pb-10 xl:pl-36 xl:pr-36 lg:pl-20 lg:pr-20 md:pl-16 md:pr-16 sm:pl-8 sm:pr-8 pl-8 pr-8 bg-slate-800">
      ...
      <motion.div animate={animation} className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 mt-6 items-baseline">
        {!isLoading &&
          campaigns.length > 0 &&
